...
Esistono tipi di accesso disponibili tramite API che non sono disponibili nell'interfaccia utente di Element.
...
* link:../api/reference_element_api_app_b_access_control.html["Scopri i tipi di accesso disponibili per le API di Element"]
* link:task_system_manage_enable_ldap_authentication.html["Abilitare l'autenticazione LDAP con l'interfaccia utente Element"]
