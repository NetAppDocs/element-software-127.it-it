...
* Aggiornare le credenziali di amministratore del cluster di archiviazione nel mnode utilizzando link:../api/reference_element_api_modifyclusteradmin.html["API modifyclusteradmin"].
...
* Per H410S e H610S nodi, link:task_post_deploy_credential_change_ipmi_password.html["Modificare la password IPM predefinita"].
