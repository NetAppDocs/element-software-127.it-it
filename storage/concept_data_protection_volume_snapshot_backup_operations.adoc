...
* link:task_data_protection_back_up_a_volume_snapshot_to_an_amazon_s3_object_store.html["Eseguire il backup di uno snapshot di volume in un archivio di oggetti Amazon S3"]
* link:task_data_protection_back_up_a_volume_snapshot_to_openstack_swift.html["Eseguire il backup di uno snapshot di volume in un archivio di oggetti OpenStack Swift"]
* link:task_data_protection_back_up_volume_to_solidfire.html["Eseguire il backup di uno snapshot di volume in un cluster SolidFire"]
