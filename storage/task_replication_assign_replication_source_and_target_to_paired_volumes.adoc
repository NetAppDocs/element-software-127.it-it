...
IMPORTANT: Se si inverte l'assegnazione di origine e di destinazione, questa azione fa sì che la coppia di volumi visualizzi il seguente messaggio finché non viene assegnata una nuova destinazione di replica: `PausedMisconfigured`
