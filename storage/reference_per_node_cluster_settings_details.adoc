...
Il seguente elenco descrive le impostazioni del cluster per un nodo di storage indicato nella pagina *Cluster Settings* dell'IP dell'interfaccia utente per nodo(https://<node[]>:442/hcc/node/cluster-settings).
