...
** *Test Connect MVIP*
+
Esegue il ping dell'indirizzo IP virtuale di gestione (MVIP) specificato ed esegue una semplice chiamata API a MVIP per verificare la connettività. Per impostazione predefinita, il test utilizza MVIP per il cluster a cui è associato il nodo.
