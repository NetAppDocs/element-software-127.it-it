...
[role="lead"]
L'interfaccia utente Web di Element utilizza il `CreateSnapMirrorRelationship` metodo per creare una relazione di protezione estesa dei dati SnapMirror tra un endpoint di origine e di destinazione.
