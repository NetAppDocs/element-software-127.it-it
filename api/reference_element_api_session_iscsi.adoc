...
[role="lead"]
L'oggetto session (iSCSI) contiene informazioni dettagliate sulla sessione iSCSI di ciascun volume. È possibile recuperare le informazioni della sessione iSCSI con il `ListISCSISessions` metodo API.
