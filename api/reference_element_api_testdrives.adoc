...
[role="lead"]
È possibile utilizzare il `TestDrives` metodo per eseguire una convalida hardware su tutte le unità del nodo. Questo metodo rileva i guasti hardware sui dischi e riporta i risultati dei test di convalida.



== Parametri

È possibile utilizzare il metodo solo `TestDrives` su nodi che non sono "attivi" in un cluster.
