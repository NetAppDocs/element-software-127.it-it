...
[role="lead"]
È possibile utilizzare il `ListVolumeStatsByVirtualVolume` metodo per elencare le statistiche di volume per qualsiasi volume del sistema associato al volume virtuale. Le statistiche sono cumulative a partire dalla creazione del volume.
