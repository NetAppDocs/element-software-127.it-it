...
[role="lead"]
È possibile utilizzare il `ListActiveAuthSessions` metodo per elencare tutte le sessioni autenticate attive. Solo gli utenti con diritti di accesso amministrativo possono chiamare questo metodo.
