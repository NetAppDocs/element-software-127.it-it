...
[role="lead"]
È possibile utilizzare il `GetDriveHardwareInfo` metodo per ottenere tutte le informazioni hardware per l'unità specificata. In genere, sono inclusi produttori, vendor, versioni e altre informazioni di identificazione hardware associate.
