...
[role="lead"]
È possibile utilizzare questo `GetClusterStats` metodo per recuperare le misurazioni di attività di alto livello per il cluster. I valori restituiti sono cumulativi dalla creazione del cluster.
