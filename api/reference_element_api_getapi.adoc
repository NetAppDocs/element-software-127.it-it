...
[role="lead"]
È possibile utilizzare il `GetAPI` metodo per ottenere un elenco di tutti i metodi API e degli endpoint API supportati che possono essere utilizzati nel sistema.
