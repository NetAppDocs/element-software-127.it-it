...
[role="lead"]
È possibile utilizzare il `GetNodeHardwareInfo` metodo per restituire tutte le informazioni e lo stato dell'hardware per il nodo specificato. In genere, sono inclusi produttori, vendor, versioni e altre informazioni di identificazione hardware associate.
