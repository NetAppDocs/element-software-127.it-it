...
[role="lead"]
Puoi utilizzare questo `DeleteStorageContainers` metodo per rimuovere dal sistema fino a 2000 container storage di Virtual Volume (VVol) contemporaneamente. I contenitori di storage rimossi non devono contenere VVol.
