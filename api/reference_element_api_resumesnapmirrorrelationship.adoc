...
[role="lead"]
L'interfaccia utente Web del software Element utilizza il `ResumeSnapMirrorRelationship` metodo per consentire trasferimenti futuri per una relazione SnapMirror inattiva.
