...
[role="lead"]
L'interfaccia utente Web del software Element utilizza il `ListSnapMirrorLuns` metodo per elencare le informazioni LUN per la relazione SnapMirror dal cluster ONTAP remoto.
