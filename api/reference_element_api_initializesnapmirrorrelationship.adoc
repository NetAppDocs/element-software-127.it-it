...
[role="lead"]
L'interfaccia utente Web del software Element utilizza il `InitializeSnapMirrorRelationship` metodo per inizializzare il volume di destinazione in una relazione SnapMirror eseguendo un trasferimento di base iniziale tra i cluster.
