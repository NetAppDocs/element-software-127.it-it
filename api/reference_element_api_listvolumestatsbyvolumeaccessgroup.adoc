...
[role="lead"]
È possibile utilizzare il `ListVolumeStatsByVolumeAccessGroup` metodo per elencare le misurazioni totali dell'attività per tutti i volumi che sono membri dei gruppi di accesso ai volumi specificati.
