...
[role="lead"]
È possibile utilizzare `ListAccounts` per ottenere l'intero elenco degli account tenant di storage, con supporto di paging opzionale. Gli account Element consentono l'accesso ai volumi.
