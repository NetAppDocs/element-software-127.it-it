...
[role="lead"]
È possibile utilizzare il `GetVolumeEfficiency` metodo per ottenere informazioni su un volume. Per calcolare la capacità viene utilizzato solo il volume indicato come parametro in questo metodo API.
