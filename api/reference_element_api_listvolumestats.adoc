...
[role="lead"]
È possibile utilizzare il `ListVolumeStats` metodo per ottenere misurazioni di attività di alto livello per un singolo volume, un elenco di volumi o tutti i volumi (se si omette il parametro volumeID). I valori di misurazione sono cumulativi dalla creazione del volume.
