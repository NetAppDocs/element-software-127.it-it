...
[role="lead"]
L'oggetto fipsReport contiene informazioni sul supporto FIPS 140-2 per tutti i nodi nel cluster di storage. È possibile recuperare queste informazioni utilizzando il `GetFipsReport` metodo .
