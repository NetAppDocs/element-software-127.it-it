...
[role="lead"]
L'oggetto fiberChannelPort contiene informazioni sulle singole porte di un nodo o su un intero nodo del cluster. È possibile recuperare queste informazioni utilizzando il `ListNodeFibreChannelPortInfo` metodo .
