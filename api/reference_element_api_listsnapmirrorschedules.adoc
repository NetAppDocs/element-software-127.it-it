...
[role="lead"]
L'interfaccia utente Web del software Element utilizza il `ListSnapMirrorSchedules` metodo per ottenere un elenco di pianificazioni disponibili in un cluster ONTAP remoto.
