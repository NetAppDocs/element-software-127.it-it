...
[role="lead"]
È possibile utilizzare questo `GetStorageContainerEfficiency` metodo per recuperare informazioni sull'efficienza relative a un contenitore di storage di volumi virtuali.
