...
[role="lead"]
È possibile utilizzare il `GetLldpConfig` metodo per ottenere la configurazione LLDP (link Layer Discovery Protocol) per ciascun nodo di un cluster di storage.
