...
[role="lead"]
È possibile utilizzare il `DeleteVolume` metodo per contrassegnare un volume attivo per l'eliminazione. Se contrassegnato, il volume viene eliminato (cancellato in modo permanente) allo scadere dell'intervallo di pulizia.
