...
[role="lead"]
È possibile utilizzare questo `ModifyVolumePair` metodo per sospendere o riavviare la replica tra una coppia di volumi. Questo metodo viene impostato sul volume di origine (il volume con accesso in lettura/scrittura).
