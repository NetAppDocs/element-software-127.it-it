...
[role="lead"]
È possibile utilizzare questo `ListVirtualVolumeBindings` metodo per ottenere un elenco di tutti i volumi virtuali nel cluster associati agli endpoint del protocollo.
