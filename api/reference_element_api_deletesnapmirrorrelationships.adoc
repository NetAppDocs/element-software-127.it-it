...
[role="lead"]
L'interfaccia utente Web di Element utilizza il `DeleteSnapMirrorRelationships` metodo per rimuovere una o più relazioni SnapMirror tra un endpoint di origine e di destinazione.
