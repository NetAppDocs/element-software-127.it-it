...
[role="lead"]
L'oggetto ontapVersionInfo contiene informazioni sulla versione API del cluster ONTAP in una relazione SnapMirror. L'interfaccia utente Web di Element utilizza il `GetOntapVersionInfo` metodo API per ottenere queste informazioni.
