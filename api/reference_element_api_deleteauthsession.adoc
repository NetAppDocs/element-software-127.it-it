...
[role="lead"]
È possibile utilizzare il `DeleteAuthSession` metodo per eliminare una sessione di autenticazione utente singola. Se l'utente chiamante non si trova in ClusterAdmins / Administrator AccessGroup, è possibile eliminare solo la sessione di autenticazione dell'utente chiamante.
