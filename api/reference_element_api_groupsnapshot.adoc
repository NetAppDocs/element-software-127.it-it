...
[role="lead"]
L'oggetto groupSnapshot contiene informazioni su uno snapshot per un gruppo di volumi. È possibile utilizzare il `ListGroupSnapshots` metodo API per recuperare le informazioni sullo snapshot di gruppo.
