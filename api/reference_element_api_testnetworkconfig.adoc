...
[role="lead"]
È possibile utilizzare il `TestNetworkConfig` metodo per verificare che le impostazioni di rete configurate corrispondano alle impostazioni di rete utilizzate nel sistema.
