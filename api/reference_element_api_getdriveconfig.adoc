...
[role="lead"]
È possibile utilizzare il `GetDriveConfig` metodo per ottenere informazioni sull'unità per i conteggi previsti delle unità di sezione e blocco, nonché per il numero di sezioni e unità di blocco attualmente collegate al nodo.
