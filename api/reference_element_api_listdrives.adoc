...
[role="lead"]
È possibile utilizzare il `ListDrives` metodo per elencare le unità esistenti nei nodi attivi del cluster. Questo metodo restituisce i dischi che sono stati aggiunti come metadati di volume o dischi a blocchi, nonché i dischi che non sono stati aggiunti e che sono disponibili.
