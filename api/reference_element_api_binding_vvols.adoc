...
[role="lead"]
L'oggetto binding contiene informazioni sull'associazione per un volume virtuale. È possibile recuperare un elenco di queste informazioni per tutti i volumi virtuali utilizzando il `ListVirtualVolumeBindings` metodo API.
