...
[role="lead"]
L'interfaccia utente Web del software Element utilizza il `ListSnapMirrorRelationships` metodo per elencare una o tutte le relazioni SnapMirror su un cluster di storage Element.
