...
[role="lead"]
È possibile utilizzare questo `GetIpmiInfo` metodo per visualizzare un report dettagliato dei sensori (oggetti) per le ventole dei nodi, le temperature di aspirazione e scarico e gli alimentatori monitorati dal sistema.
