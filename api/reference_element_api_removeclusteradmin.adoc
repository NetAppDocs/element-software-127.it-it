...
[role="lead"]
È possibile utilizzare questo `RemoveClusterAdmin` metodo per rimuovere un amministratore del cluster, un amministratore del cluster LDAP o un amministratore del cluster IdP (Identity Provider) di terze parti. Non è possibile rimuovere l'account "admin" Cluster Admin.
