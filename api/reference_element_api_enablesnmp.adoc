...
[role="lead"]
È possibile utilizzare `EnableSnmp` il metodo per attivare SNMP sui nodi cluster. Quando si attiva SNMP, l'azione viene applicata a tutti i nodi nel cluster e i valori passati sostituiscono tutti i valori impostati in qualsiasi chiamata precedente a `EnableSnmp`.
