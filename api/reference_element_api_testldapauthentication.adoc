...
[role="lead"]
È possibile utilizzare il `TestLdapAuthentication` metodo per convalidare le impostazioni di autenticazione LDAP attualmente abilitate. Se la configurazione è corretta, la chiamata API restituisce l'appartenenza di gruppo dell'utente testato.
