...
[role="lead"]
Puoi utilizzare questo `ListNodeStats` metodo per visualizzare le misurazioni dell'attività di alto livello per tutti i nodi di storage in un cluster di storage.
