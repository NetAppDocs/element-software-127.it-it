...
[role="lead"]
È possibile utilizzare il `CreateQoSPolicy` metodo per creare un oggetto QoSPolicy che può essere successivamente applicato a un volume al momento della creazione o della modifica. Un criterio QoS ha un ID univoco, un nome e impostazioni QoS.
