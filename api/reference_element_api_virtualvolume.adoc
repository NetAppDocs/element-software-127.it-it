...
[role="lead"]
L'oggetto virtualVolume contiene informazioni di configurazione su un volume virtuale e informazioni sugli snapshot del volume virtuale. Non include informazioni sull'utilizzo o sul runtime. È possibile utilizzare il `ListVirtualVolumes` metodo per recuperare queste informazioni per un cluster.
