...
[role="lead"]
È possibile utilizzare il `ListVolumeStatsByAccount` metodo per elencare le misurazioni di attività di alto livello per ogni account. I valori vengono sommati da tutti i volumi di proprietà dell'account.
