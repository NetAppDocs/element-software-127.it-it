...
[role="lead"]
È possibile utilizzare il `GetNodeFipsDrivesReport` metodo per controllare lo stato della capacità di crittografia del disco FIPS 140-2 di un singolo nodo nel cluster di storage. È necessario eseguire questo metodo su un singolo nodo di storage.
