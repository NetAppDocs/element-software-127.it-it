...
[role="lead"]
L'oggetto sessione contiene informazioni su ogni sessione Fibre Channel visibile al cluster e sulle porte di destinazione su cui è visibile. È possibile recuperare queste informazioni con il `ListFibreChannelSessions` metodo API.
