...
[role="lead"]
L'interfaccia utente Web di Element utilizza `GetOntapVersionInfo` per ottenere informazioni sul supporto della versione API dal cluster ONTAP in una relazione di SnapMirror.
