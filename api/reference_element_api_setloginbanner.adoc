...
[role="lead"]
È possibile utilizzare il `SetLoginBanner` metodo per configurare il banner Termini di utilizzo che gli utenti visualizzano quando accedono all'interfaccia Web di Element.
