...
[role="lead"]
È possibile utilizzare il `SetSSLCertificate` metodo per impostare un certificato SSL utente e una chiave privata per i nodi di archiviazione nel cluster.
