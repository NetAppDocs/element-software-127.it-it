...
[role="lead"]
È possibile utilizzare il `ClearClusterFaults` metodo per cancellare le informazioni relative ai guasti rilevati in precedenza e alla corrente. I guasti risolti e quelli non risolti possono essere cancellati.
