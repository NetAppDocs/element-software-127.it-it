...
[role="lead"]
È possibile utilizzare questo `ModifyVolumeAccessGroup` metodo per aggiornare gli iniziatori e aggiungere o rimuovere volumi da un gruppo di accesso ai volumi.
