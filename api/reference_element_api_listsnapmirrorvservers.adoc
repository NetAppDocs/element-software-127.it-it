...
[role="lead"]
L'interfaccia utente Web del software Element utilizza il `ListSnapMirrorVservers` metodo per elencare tutti i Vserver SnapMirror disponibili in un sistema ONTAP remoto.
