...
[role="lead"]
È possibile utilizzare questo `ListProtocolEndpoints` metodo per recuperare le informazioni su tutti gli endpoint del protocollo nel cluster. Gli endpoint del protocollo regolano l'accesso ai contenitori di storage dei volumi virtuali associati.
