...
[role="lead"]
L'oggetto ProtocolEndpoint contiene gli attributi di un endpoint del protocollo. È possibile recuperare queste informazioni per tutti gli endpoint del protocollo nel cluster utilizzando il `ListProtocolEndpoints` metodo API.
