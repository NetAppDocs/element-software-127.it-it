...
[role="lead"]
Il `GetConfig` metodo restituisce una risposta simile all'esempio seguente. A causa della lunghezza, la risposta contiene informazioni solo per un nodo del cluster.
