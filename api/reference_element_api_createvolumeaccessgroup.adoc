...
[role="lead"]
È possibile utilizzare `CreateVolumeAccessGroup` per creare un nuovo gruppo di accesso ai volumi. Quando si crea il gruppo di accesso al volume, è necessario assegnargli un nome e, facoltativamente, è possibile inserire iniziatori e volumi.
