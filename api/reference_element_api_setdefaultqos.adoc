...
[role="lead"]
È possibile utilizzare questo `SetDefaultQoS` metodo per configurare i valori di qualità del servizio (QoS) predefiniti (misurati in input e output al secondo o IOPS) per un volume.
