...
[role="lead"]
È possibile utilizzare `CreateBackupTarget` per creare e memorizzare le informazioni sulla destinazione di backup in modo da non doverle reinserire ogni volta che viene creato un backup.
