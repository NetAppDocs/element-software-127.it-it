...
[role="lead"]
È possibile utilizzare il `RemoveVolumePair` metodo per rimuovere l'associazione remota tra due volumi. Utilizzare questo metodo sui volumi di origine e di destinazione associati. Quando si rimuovono le informazioni di accoppiamento del volume, i dati non vengono più replicati nel o dal volume.
