...
[role="lead"]
Questo `CreateClusterInterfacePreference` metodo permette ai sistemi integrati con cluster di storage che eseguono il software Element di creare e memorizzare informazioni arbitrarie nel cluster di storage. Questo metodo è per uso interno.
