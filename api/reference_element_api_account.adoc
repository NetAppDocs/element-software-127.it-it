...
[role="lead"]
L' `account`oggetto contiene informazioni su un account. Questo oggetto include solo informazioni "configurate" sull'account e non informazioni sull'utilizzo o sul runtime.
