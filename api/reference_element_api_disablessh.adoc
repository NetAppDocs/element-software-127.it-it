...
[role="lead"]
È possibile utilizzare il `DisableSsh` metodo per disattivare il servizio SSH per un singolo nodo di storage. Questo metodo non influisce sulla durata del timeout del servizio SSH a livello di cluster.
