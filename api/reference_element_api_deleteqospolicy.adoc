...
[role="lead"]
È possibile utilizzare il `DeleteQoSPolicy` metodo per eliminare un criterio QoS dal sistema. Le impostazioni di QoS per tutti i volumi creati o modificati con questo criterio non sono influenzate.
